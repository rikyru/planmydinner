...
const WeekView = defineComponent({
        ...
        <div class="week-layout" @click="closeMealMenu">
            ...
            <div v-if="showModal" class="modal-overlay" @click.self="closeModal">
                <div class="modal">
                    ...
                    <div v-if="!loadingOptions" style="display:flex;gap:10px;margin-top:12px;flex-wrap:wrap;">
    ...
    methods: {
        ...
        async applyFantasySlot(dateStr, mealType, fromModal = false) {
            ...
            try {
                // ExtraFantasy vuole sempre una proposta creativa dall'AI, non catalogo
                // (che è invece il default di /change-recipe per "↺ Cambia ricetta").
                const params = new URLSearchParams({
                    profile_id_A: this.profileA.id,
                    profile_id_B: this.profileB.id,
                    meal_type: mealType,
