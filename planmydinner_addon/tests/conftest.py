...
def setup_database():
    ...
    db.add(UnitConversion(unit="piatto", grams_equivalent=300.0, ml_equivalent=None))
    db.add(UnitConversion(unit="porzione", grams_equivalent=150.0, ml_equivalent=None))
    db.add(UnitConversion(unit="rotolo", grams_equivalent=None, ml_equivalent=None))
    db.commit()
    ...
    recipe_data = {
        ...
        "content": [
            {"name": "Pasta", "food_group": "carboidrato", "quantities": {"persona_a": {"qty": 100, "unit": "g", "grams_equiv": 100.0}, "persona_b": {"qty": 120, "unit": "g", "grams_equiv": 120.0}}},
            {"name": "Pomodoro", "food_group": "verdura", "quantities": {"persona_a": {"qty": 200, "unit": "g", "grams_equiv": 200.0}, "persona_b": {"qty": 200, "unit": "g", "grams_equiv": 200.0}}}
        ],
...
def planner_seeded_database(setup_database):
    ...
    recipe1_data = {
        ...
        "is_composed_dish": False,
        "content": [
            {"name": "Pasta", "food_group": "carboidrato", "quantities": {"persona_a": {"qty": 80, "unit": "g", "grams_equiv": 80}, "persona_b": {"qty": 100, "unit": "g", "grams_equiv": 100}}},
            {"name": "Pesto di zucchine", "food_group": "grasso", "quantities": {"persona_a": {"qty": 50, "unit": "g", "grams_equiv": 50}, "persona_b": {"qty": 0, "unit": "g", "grams_equiv": 0}}},
            {"name": "Pesto classico", "food_group": "grasso", "quantities": {"persona_a": {"qty": 0, "unit": "g", "grams_equiv": 0}, "persona_b": {"qty": 50, "unit": "g", "grams_equiv": 50}}},
            {"name": "Tofu", "food_group": "proteina", "quantities": {"persona_a": {"qty": 150, "unit": "g", "grams_equiv": 150}, "persona_b": {"qty": 150, "unit": "g", "grams_equiv": 150}}},
            {"name": "Verdure miste", "food_group": "verdura", "quantities": {"persona_a": {"qty": 50, "unit": "g", "grams_equiv": 50}, "persona_b": {"qty": 50, "unit": "g", "grams_equiv": 50}}}
        ],
    ...
    recipe2_data = {
        ...
        "is_composed_dish": False,
        "content": [
            {"name": "Pollo", "food_group": "proteina", "quantities": {"persona_a": {"qty": 0, "unit": "g", "grams_equiv": 0}, "persona_b": {"qty": 150, "unit": "g", "grams_equiv": 150}}},
            {"name": "Tofu", "food_group": "proteina", "quantities": {"persona_a": {"qty": 150, "unit": "g", "grams_equiv": 150}, "persona_b": {"qty": 0, "unit": "g", "grams_equiv": 0}}},
            {"name": "Riso", "food_group": "carboidrato", "quantities": {"persona_a": {"qty": 80, "unit": "g", "grams_equiv": 80}, "persona_b": {"qty": 100, "unit": "g", "grams_equiv": 100}}},
            {"name": "Olio", "food_group": "grasso", "quantities": {"persona_a": {"qty": 50, "unit": "g", "grams_equiv": 50}, "persona_b": {"qty": 50, "unit": "g", "grams_equiv": 50}}},
            {"name": "Verdure", "food_group": "verdura", "quantities": {"persona_a": {"qty": 50, "unit": "g", "grams_equiv": 50}, "persona_b": {"qty": 50, "unit": "g", "grams_equiv": 50}}}
        ],
    ...
    recipe3_data = {
        ...
        "is_composed_dish": False,
        "content": [
            {"name": "Maiale", "food_group": "proteina", "quantities": {"persona_a": {"qty": 0, "unit": "g", "grams_equiv": 0}, "persona_b": {"qty": 200, "unit": "g", "grams_equiv": 200}}},
            {"name": "Patate", "food_group": "carboidrato", "quantities": {"persona_a": {"qty": 100, "unit": "g", "grams_equiv": 100}, "persona_b": {"qty": 100, "unit": "g", "grams_equiv": 100}}},
            {"name": "Olio", "food_group": "grasso", "quantities": {"persona_a": {"qty": 50, "unit": "g", "grams_equiv": 50}, "persona_b": {"qty": 50, "unit": "g", "grams_equiv": 50}}},
            {"name": "Verdure", "food_group": "verdura", "quantities": {"persona_a": {"qty": 50, "unit": "g", "grams_equiv": 50}, "persona_b": {"qty": 50, "unit": "g", "grams_equiv": 50}}}
        ],
    ...
    create_pantry_item_in_db(db_session, {"id": "pantry_zucchine", "name": "Zucchine", "quantity": 500, "unit": "g", "expiration_date": (date.today() + timedelta(days=5)).isoformat()})
    ...
    meal_plan_A_data = {
        ...
        "daily_plans": [
            {"date": (date.today() + timedelta(days=i)).isoformat(), "meals": [
                {"meal_type": "pranzo", "items": [{"item_name": "Pasta", "food_group": "carboidrato", "quantity": 80, "unit": "g"}]},
                {"meal_type": "cena", "items": [{"item_name": "Tofu", "food_group": "proteina", "quantity": 150, "unit": "g"}]}
            ]} for i in range(7)
        ]
    }
    ...
    meal_plan_B_data = {
        ...
        "daily_plans": [
            {"date": (date.today() + timedelta(days=i)).isoformat(), "meals": [
                {"meal_type": "pranzo", "items": [{"item_name": "Pasta", "food_group": "carboidrato", "quantity": 100, "unit": "g"}]},
                {"meal_type": "cena", "items": [{"item_name": "Pollo", "food_group": "proteina", "quantity": 150, "unit": "g"}]}
            ]} for i in range(7)
        ]
    }
